...
class Solution {
    public int solution(int[] priorities, int location) {
        ...
        int temp2 = 0;
        int count = 0;
        int[] count2 = new int[priorities.length];
...
//                     if(i+j >= priorities.length-1){
//                        i = 0;
//                     }
//                      count2[j] = priorities[j+i];
//                 }
//             }
...
//         }
        ...
        if(temp == temp2){
            for(int j = 0; j < priorities.length; j++){
                if(count+j >= priorities.length-1){
                   count = 0;
                }
                 count2[j] = priorities[j+count];
            }
        }
        answer = count2[location];
...
class Solution {
    public int solution(int[] priorities, int location) {
        ...
        if(temp == temp2){
            for(int j = -1; j < priorities.length-1; j++){
        ...
        for(int j = -1; j < priorities.length-1; j++){
            ...
            if(priorities[location+1] == priorities[j+1])
                answer = count2[j+1]+1;
        }
