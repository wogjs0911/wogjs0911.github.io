...
- 스프링 부트에서 Mybatis를 순수 자바로 사용하는 방법 정리 1: 
	...
	- Mybatis의 보따리는 Mapper 컨테이너이다. Mybatis의 Mapper 컨테이너 실제 자료형은 SQLSessionFactory이다.
...
<br><br>
### 4) Mybatis에 delete, insert 구문 추가 :
