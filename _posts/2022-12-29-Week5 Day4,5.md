...
- 이벤트 : load가 되면, click할 때, keydown 할 떄가 모두 객체 지향이다.
...
# 4. 게임 만드는 과정 : 22.12.29

- 먼저, 역할을 부여한다. 

- 개체와 객체를 분석하고 의미를 부여한다.

- 너무 벡터를 많이 사용하고 있으면, 문제가 많다.

- 우리는 게임을 최대한 현실과 이질감이 없게 만들기!!

- 이정도면 되나? 아직 감이 없어서...부터 시작한다!!
