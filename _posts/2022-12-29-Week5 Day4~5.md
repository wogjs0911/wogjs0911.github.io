...
```html
    <script>
         // **** 최종 문제점 : 값을 넘겨 받을 때, 인자가 없으면, undefined가 출력된다.
...
```
        ...
        // --------------------------------------------------------------------------------------------
         자바스크립트에서는 만들면서 정의하기 때문에 반복해서 코드를 만들어야한다. -> 메모리 문제
         모든 객체의 공유할 정보를 가지고 있는 것이다. 상속아닌 상속의 효과를 가지고 있따.
         회귀함수가 아니다. 이지산?
...
```
        // --------------------------------------------------------------------------------------------
         프로토타입을 계속 만들어줘야한다. 너무 반복적인 일을 해야 한다.
...
```   
        // --------------------------------------------------------------------------------------------
        // 프르토 타입의 다른 특징 : 모든 생성자는 자기 생성자를 알고 있다.
